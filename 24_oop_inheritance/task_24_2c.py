...
Проверить, что метод send_command кроме команды, принимает еще и дополнительные аргументы, например, strip_command.
...
#     по сути тут нужно добавить, чтобы принимались *args, **kwargs
