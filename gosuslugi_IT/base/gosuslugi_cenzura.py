...
Выходные данные:
####### коричневая лиса прыгает через ####### собаку.

Пример 5 (тест):
Входные данные:
Не используйте оскорбительные слова.
оскорбление
...
Пример 6 (тест):
Входные данные:
Не используйте неприемлемых слов невпопад.
не

Выходные данные:
## используйте неприемлемых слов невпопад.
