...
#     if show and config:
#         raise ValueError('Передано оба ключевых аргумента show и config. Нужно оставить один')
#     if device and show:
...
# if __name__ == "__main__":
#     commands = ["no logging 10.255.255.1", "no logging buffered 20010", "logging console"]
#     command = "sh ip int br"
...
#     print(send_commands(device, show=command, config=commands))
